...
struct IdxFile : public detail::IdxFileBase {
    ...
    bool get_grid(int hz_level, OUT Vector3i& from, OUT Vector3i& to,
                  OUT Vector3i& stride) const;
    ...
    samples. */
    bool get_grid(const Volume& sub_vol, int hz_level, OUT Vector3i& from,
                  OUT Vector3i& to, OUT Vector3i& stride) const;
    bool get_grid_inclusive(int hz_level, OUT Vector3i& from,
                            OUT Vector3i& to, OUT Vector3i& stride) const;
    bool get_grid_inclusive(const Volume& sub_vol, int hz_level,
                            OUT Vector3i& from, OUT Vector3i& to,
                            OUT Vector3i& stride) const;
...
void create_idx_file(const Vector3i& dims, int num_fields, const IdxType& type,
